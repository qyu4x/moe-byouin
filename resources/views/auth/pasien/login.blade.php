    ...
    <div class="cards border px-5 py-3 rounded-lg" style="width: 30%; background-color: white;">
        ...
        <form action="/pasien/login" method="POST">
            ...
            <div class="form-group d-flex justify-content-between align-items-center">
                <a href={{url('/pasien/register')}} class="link-offset-2 link-offset-3-hover link-underline link-underline-opacity-0 link-underline-opacity-75-hover">Buat Akun</a>
